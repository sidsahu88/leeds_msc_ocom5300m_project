...
def train_capsnet(n_epochs, model, criterion, train_loader, test_loader, train_dir, logger, calc_ccm=False, device='cpu', checkpoint_file=None):
    ...
    if checkpoint_file is None:
        ...
        epoch_losses = model_checkpoint['epoch_loss']
        epoch_accuracies = model_checkpoint['epoch_accuracy']
